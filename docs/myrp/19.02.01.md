...
As alterações estarão disponíveis no ambiente demo.myrp.com.br (212) 7 dias antes da liberação da versão em produção.

## [#MYRP-3764](https://devmyrp.atlassian.net/browse/MK-71): SPED - Bloco K 
* Para indústrias e atacados que possuem a obrigatoriedade de gerar o "BLOCO K", o myrp adicionou ao SPED os registros do Bloco K que são suficientes para atender a primeira onda de entrega. Neste momento inicial, estamos entregando os registros K200 (Estoque Escriturado) e K280 (Correção de apontamento de estoque escriturado) - estes 2 registros são obrigatórios desde 01/01/2019 e terá sua primeira entrega em fevereiro. 

## [#MK-62](https://devmyrp.atlassian.net/browse/MK-62): Alerta para ajuste de estoque manual 
* Pensando em nossos clientes com obrigatoriedade de entregar o Bloco K, criamos dois alertas para o menu "Controle de Inventário" que informa as possíveis consequências da alteração manual de estoque.

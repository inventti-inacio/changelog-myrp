...
Neste mesmo desenvolvimento, trabalhamos com questão da melhoria do campo "DESCRIÇÃO" para que apareça acima dos campos mais pesquisados.

![image](https://i.imgur.com/vuxEqmP.png)
Também foi melhorado a disposição dos filtros, para que fique mais evidente que a "Lupa" é um filtro avançado para os nossos clientes e usuários. 
